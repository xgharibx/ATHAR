...
export function Slider(props: SliderPrimitive.SliderProps) {
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="block w-6 h-6 bg-white rounded-full border border-black/20 shadow-lg focus:outline-none focus:ring-2 focus:ring-accent-50 focus:ring-offset-1 focus:ring-offset-transparent" />
    </SliderPrimitive.Root>
  );
}
