...
// 📜 البشارة في التوراة — Deuteronomy foretells the Prophet from among the brethren (Ishmael)
// Unfurling Torah scroll + word-by-word highlight of the prophecy + match cards (same design as Isaiah 40).

type Tok = { t: string; c?: string };
const VERSE: Tok[] = [
  { t: 'I will raise up for them a' }, { t: 'prophet', c: '#d4a853' },
  { t: 'like you from among their' }, { t: 'brothers', c: '#f472b6' },
  { t: ', and I will put my' }, { t: 'words', c: '#2dd4a8' },
  { t: 'in his mouth.' },
];

const MATCHES = [
  { ref: 'تثنية 18:18', text: '“A prophet like Moses”', match: 'محمد ﷺ = نبيٌّ بشريعةٍ مثل موسى', color: '#d4a853' },
  { ref: 'تثنية 18:18', text: '“From among their brothers”', match: 'إخوة بني إسرائيل = بنو إسماعيل = العرب', color: '#f472b6' },
  { ref: 'تثنية 33:2', text: '“He shone forth from Paran”', match: 'فاران = مكة · مَهبط الوحي', color: '#2dd4a8' },
];
