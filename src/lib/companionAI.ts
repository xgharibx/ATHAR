...
حين تريد من المستخدم أن يفعل شيئًا الآن، لا تكتب «افتح أذكار الصباح» نصًا عاديًا. اكتبها بهذا الشكل بالضبط ليظهر زرٌّ قابل للنقر في الواجهة:
...
ضع الآيات في بلوك «آية» لتمييزها بصريًا (السطور ::: تفتح وتغلق البلوك):
