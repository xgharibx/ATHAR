#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Phase 34: Home.tsx — daily Quran goal progress pill after vocab card."""
...
# Insert after the vocab card closing section, before the library card
old_library = (
    '      {/* \u0645\u0643\u062a\u0628\u0629 \u0627\u0644\u0645\u062d\u062a\u0648\u0649 */}\n'
    '      <Card className="p-4">'
)
new_library = (
    ...
    '            }}\n'
    '            aria-label="\u0647\u062f\u0641 \u0627\u0644\u0642\u0631\u0622\u0646 \u0627\u0644\u064a\u0648\u0645\u064a \u2014 \u0627\u0646\u062a\u0642\u0644 \u0625\u0644\u0649 \u0627\u0644\u0642\u0631\u0622\u0646"\n'
    '          >\n'
    ...
    '                  {todayAyahs.toLocaleString("ar-EG")} / {goal.toLocaleString("ar-EG")}\n'
    '                </span>\n'
    '              </div>\n'
    ...
    '                  style={{\n'
    '                    width: `${pct}%`,\n'
    '                    background: met ? "var(--ok)" : "var(--accent)",\n'
    '                  }}\n'
    '                />\n'
    '              </div>\n'
    '            </div>\n'
